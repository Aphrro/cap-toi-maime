...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ $title }}</title>
        <meta name="description" content="Trouvez des thérapeutes spécialisés dans le refus scolaire anxieux en Suisse romande.">
    ...
    <body class="antialiased font-sans bg-white">
        ...
        @php
            ...
            $footerDescription = $footerConfig['description'] ?? 'Association dédiée à l\'accompagnement des familles confrontées à la phobie scolaire en Suisse romande.';
            $footerColumns = $footerConfig['columns'] ?? [
                ...
                [
                    ...
                    'links' => [
                        ...
                        ['label' => 'Charte éthique', 'url' => '/charte-ethique'],
                    ]
                ],
                [
                    'title' => 'Contact',
            ...
            $footerCopyright = $footerConfig['copyright'] ?? '&copy; ' . date('Y') . ' Cap Toi M\'aime. Tous droits réservés.';
        ...
        <footer class="bg-ctm-black text-gray-300">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <div class="mt-12 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center gap-4">
                    ...
                    <p class="text-xs text-gray-600">Annuaire de professionnels spécialisés dans le refus scolaire anxieux</p>
                </div>
            </div>
        </footer>
    </body>
