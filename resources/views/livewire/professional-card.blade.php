    ...
    <div class="bg-ctm-burgundy p-6 relative overflow-hidden">
        ...
        <div class="relative">
            <div class="flex justify-between items-start mb-3">
                <div class="flex-1">
                    <h3 class="text-lg font-semibold text-white mb-1 flex items-center gap-1.5">
                        {{ $professional->full_name }}
                        @if($professional->is_verified)
                            <svg class="w-5 h-5 text-green-400 flex-shrink-0" viewBox="0 0 24 24" fill="currentColor">
